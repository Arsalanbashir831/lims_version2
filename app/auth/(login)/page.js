  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-r from-gray-50 to-gray-200 p-6">
      ...
      <div className="absolute top-8">
        <Image src="/logo.png" alt="LIMS Logo" width={450} height={450} priority />
      </div>
      ...
      <Card className="w-full max-w-lg shadow-xl bg-white rounded-lg border border-gray-200 p-8">
        <CardHeader className="text-center">
          ...
          <p className="text-gray-500 text-sm">Sign in to continue to the Laboratory Integrated Management System</p>
        </CardHeader>
        <CardContent>
          ...
          <div className="text-center mt-6 text-gray-600 text-sm">
            <p>Dont have an account? 
              <a href="/auth/register" className="text-green-600 font-medium hover:underline ml-1">Register</a>
            </p>
          </div>
        </CardContent>
      </Card>
