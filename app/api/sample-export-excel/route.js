...
export async function POST(req) {
  try {
    const { fileName, imagePath, logoBase64, sampleInfo, sampleDetails, otherInfo } = await req.json();
    ...
    subHeaderCell.value = "LIMS Coordinator on authority of GRIPCO MATERIAL TESTING";
    ...
    footerCell5.alignment = { horizontal: "center", vertical: "middle", wrapText: true };
